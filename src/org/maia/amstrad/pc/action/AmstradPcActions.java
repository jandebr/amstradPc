...
public class AmstradPcActions {
	...
	public ProgramBrowserStyleAction getProgramBrowserStyleAction(AmstradProgramBrowserStyle style) {
		ProgramBrowserStyleAction action = programBrowserStyleActions.get(style);
		if (action == null) {
