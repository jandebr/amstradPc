...
public abstract class FileChooserAction extends AmstradPcAction {
	...
	protected JFileChooser getFileChooser() {
		...
		if (fileChooser == null) {
			...
			fileChooser.addAncestorListener(new CloseFileChooserDialogHandler());
		} else {
	...
	private class CloseFileChooserDialogHandler implements AncestorListener {

		public CloseFileChooserDialogHandler() {
		}
