...
public abstract class AmstradContext {
	...
	private static final String SETTING_PROGRAM_BROWSER_STARTUP_ANIMATION_TRIGGER = "program_browser.startup_animation.trigger";
	...
	public ProgramBrowserStartupAnimationTrigger getStartupAnimationTrigger() {
		return ProgramBrowserStartupAnimationTrigger
				.valueOf(getUserSettings().get(SETTING_PROGRAM_BROWSER_STARTUP_ANIMATION_TRIGGER,
						ProgramBrowserStartupAnimationTrigger.DELAYED.name()).toUpperCase());
	}

	public void setStartupAnimationTrigger(ProgramBrowserStartupAnimationTrigger trigger) {
		getUserSettings().set(SETTING_PROGRAM_BROWSER_STARTUP_ANIMATION_TRIGGER, trigger.name());
	}
	...
	public AmstradProgramBrowserConfiguration getProgramBrowserConfiguration(AmstradPc amstradPc) {
		...
		configuration.setStartupAnimationTrigger(getStartupAnimationTrigger());
		return configuration;
	}
	...
	public void setProgramBrowserConfiguration(AmstradProgramBrowserConfiguration configuration, AmstradPc amstradPc) {
		...
		setStartupAnimationTrigger(configuration.getStartupAnimationTrigger());
