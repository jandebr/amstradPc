...
public abstract class Processor extends Device {
	...
	public void runTo(int address) {
		while (!shouldStop && getProgramCounter() != address) {
			step();
		}
	}
	...
	/**
	 * Notify all objects observing this Processor's program counter that the program counter value has changed.
	 * Observers are notified in the order that they were attached.
	 */
