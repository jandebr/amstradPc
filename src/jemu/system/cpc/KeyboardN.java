...
public class KeyboardN extends Keyboard {
  ...
  protected static final int[] KEY_MAP = {
    ...
    // Row 8
    KeyEvent.VK_1, KeyEvent.VK_2, KeyEvent.VK_ESCAPE, -1,
    KeyEvent.VK_TAB, -1, KeyEvent.VK_CAPS_LOCK, KeyEvent.VK_Z,

    // Row 9
    KeyEvent.VK_Q, KeyEvent.VK_A, KeyEvent.VK_O, KeyEvent.VK_P,
    KeyEvent.VK_SPACE, KeyEvent.VK_CONTROL, -1, KeyEvent.VK_BACK_SPACE
  };
