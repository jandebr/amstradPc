...
/**
 * Title: JavaCPC Description: The Java CPC Emulator Copyright: Copyright (c) 2002-2008 Company:
 * 
...
public class CPC extends Computer {
	...
	public static boolean playing, savecheck, stoptape, relay, rec, rew, play, ffwd, tapedeck = false;
	...
	public String MP3_HEADER_A = "Ã¿Ã»Â�Ã„";
	...
	protected int[] WAV_HEADER_11KHz = { 0x52, 0x49, 0x46, 0x46, 0xD9, 0xFC, 0xA4, 0x00, 0x57, 0x41, 0x56, 0x45, 0x66,
			0x6D, 0x74, 0x20, 0x10, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x11, 0x2b, 0x00, 0x00, 0x11, 0x2b, 0x00,
			0x00, 0x01, 0x00, 0x08, 0x00, 0x64, 0x61, 0x74, 0x61, 0xB5, 0xFC, 0xA4, 0x00 };
	protected int[] WAV_HEADER_22KHz = { 0x52, 0x49, 0x46, 0x46, 0xD9, 0xFC, 0xA4, 0x00, 0x57, 0x41, 0x56, 0x45, 0x66,
			0x6D, 0x74, 0x20, 0x10, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x22, 0x56, 0x00, 0x00, 0x22, 0x56, 0x00,
			0x00, 0x01, 0x00, 0x08, 0x00, 0x64, 0x61, 0x74, 0x61, 0xB5, 0xFC, 0xA4, 0x00 };
	protected int[] WAV_HEADER_44KHz = { 0x52, 0x49, 0x46, 0x46, 0xD9, 0xFC, 0xA4, 0x00, 0x57, 0x41, 0x56, 0x45, 0x66,
			0x6D, 0x74, 0x20, 0x10, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x44, 0xac, 0x00, 0x00, 0x44, 0xac, 0x00,
			0x00, 0x01, 0x00, 0x08, 0x00, 0x64, 0x61, 0x74, 0x61, 0xB5, 0xFC, 0xA4, 0x00 };

	public int[] SCR_HEADER = {  };

	public int[] PAL_HEADER = {  };

	public int[] PAL_INK = { 0x54, 0x44, 0x55, 0x5c, 0x58, 0x5d, 0x4c, 0x45, 0x4d, 0x56, 0x46, 0x57, 0x5e, 0x40, 0x5f,
	...
	protected int audioAdd = psg.getSoundPlayer().getClockAdder(AUDIO_TEST, CYCLES_PER_SECOND_CPC);
	...
	protected final int[] PSG_VALUES = new int[] { psg.BC2_MASK, psg.BC2_MASK | psg.BC1_MASK,
			psg.BC2_MASK | psg.BDIR_MASK, psg.BC2_MASK | psg.BDIR_MASK | psg.BC1_MASK };
	...
	private void initCPCType(String name) {
		...
		// Manual rom settings
			...
			if (!Switches.LOWER.equals("none"))
				lowerROM = Switches.LOWER;
			if (!Switches.UPPER_0.equals("none"))
				upperROMs.put("0", Switches.UPPER_0);
			if (!Switches.UPPER_1.equals("none"))
				upperROMs.put("1", Switches.UPPER_1);
			if (!Switches.UPPER_2.equals("none"))
				upperROMs.put("2", Switches.UPPER_2);
			if (!Switches.UPPER_3.equals("none"))
				upperROMs.put("3", Switches.UPPER_3);
			if (!Switches.UPPER_4.equals("none"))
				upperROMs.put("4", Switches.UPPER_4);
			if (!Switches.UPPER_5.equals("none"))
				upperROMs.put("5", Switches.UPPER_5);
			if (!Switches.UPPER_6.equals("none"))
				upperROMs.put("6", Switches.UPPER_6);
			if (!Switches.UPPER_7.equals("none"))
				upperROMs.put("7", Switches.UPPER_7);
			if (!Switches.UPPER_8.equals("none"))
				upperROMs.put("8", Switches.UPPER_8);
			if (!Switches.UPPER_9.equals("none"))
				upperROMs.put("9", Switches.UPPER_9);
			if (!Switches.UPPER_A.equals("none"))
				upperROMs.put("10", Switches.UPPER_A);
			if (!Switches.UPPER_B.equals("none"))
				upperROMs.put("11", Switches.UPPER_B);
			if (!Switches.UPPER_C.equals("none"))
				upperROMs.put("12", Switches.UPPER_C);
			if (!Switches.UPPER_D.equals("none"))
				upperROMs.put("13", Switches.UPPER_D);
			if (!Switches.UPPER_E.equals("none"))
				upperROMs.put("14", Switches.UPPER_E);
			if (!Switches.UPPER_F.equals("none"))
				upperROMs.put("15", Switches.UPPER_F);
		}
		...
		if (tapeloaded) {
			...
			if (ffwd) {
				...
				if (number <= (tapesample.length - 25000))
					number = number + 25000;
				else if (number <= (tapesample.length - 2500))
					number = number + 2500;
				else if (number <= (tapesample.length - 1000))
					number = number + 300;
	...
	/**
	 * This should really be done using CPC key codes and overriding the keepRelay returned in readPort for the PSG port
	 * read.
	 */
	protected static final int[] ASC_TO_KEY = { KeyEvent.VK_SPACE, KeyEvent.VK_1, KeyEvent.VK_2, KeyEvent.VK_3, // SPACE
																												// !"#
																												// FTTT
	...
	protected String BIN_EYECATCHER = "File exported by" + "     JavaCPC    ";
	...
	/*
	 * protected static final int VER_INT_BLOCK = 0x006d; protected static final int VER_MODES = 0x006e;
	 */
	...
	public void SNA_Save(int sizemem) {
		String filename = Settings.get(Settings.SNAPSHOT_FILE, "");
		if (filename.isEmpty()) {
		...
		if (!filename.isEmpty()) {
			SNA_Save(sizemem, new File(filename));
		}
		reSync();
	}

	private void SNA_Save(int sizemem, File file) {
			...
			if ((execaddress != 0 && !CNG) || (filetype == 0 && !CNG)) {
				if (filetype == 2) {
					if (execaddress != 0 && (filetype >= 2 && filetype <= 3)) {
						int ok = JOptionPane.showConfirmDialog(dummy, "Execute binary?", "Please choose",
								JOptionPane.YES_NO_OPTION);
						if (ok == JOptionPane.YES_OPTION)
	...
	public void BIN_Export() {
		...
		if (filename != null) {
			...
			Object[] message = { "Internal name", InternalName, "Start address", Address, "Length", Startaddress,
					"Exec. address (optional)", Exec, AmHeader };
		...
		if (filename != null) {
			...
			try {
				...
				if (!soverscan) {
					...
					if (RETURN) {
						data[adr + 33] = (byte) 0xc9;
						data[adr + 34] = (byte) 0x00;
						data[adr + 35] = 0x00;
					}
				}
	...
	public void storeYM() {
		...
		if (doRecord) {
			...
			YMControl.doYMDisplay(minutes, seconds, milliseconds, "recording...", minutes, seconds);
	...
	public void saveYM(String savename) {
		 ...
		 * 
		 * Offset Size Type Comment 0 4 DWORD ID of YM5 format. ('YM5!') 4 8 string[8] Check String ('LeOnArD!') 12 4
		 * DWORD Nb of valid VBL of the file 16 4 DWORD Song attributes (see bellow) 20 2 WORD Nb of digi-drum sample
		 * (can be 0) 22 4 DWORD YM2149 External frequency in Hz (1000000) 26 2 WORD Player frequency in Hz (50Hz for
		 * almost player) 28 4 DWORD VBL number to loop the song. (0 is default) 32 2 WORD Must be 0 for the moment ? ?
		 * NT-String Name of the song ? ? NT-String Name of the author ? ? NT-String Comments (Name of the YM converter
		 * !) ? ? All YM2149 registers ? 4 DWORD End-File check ('End!')
		 */
		atari_st_mode = false;
		spectrum_mode = false;
		psg.changeClockSpeed(CYCLES_PER_SECOND_CPC);
	...
	public void CSWLoad(String name, byte[] data) {
		...
		if (odd)
			pol = "negative";
		/*
		 * Object[] options = {"Polarity +", "Polarity-"}; int n = JOptionPane.showOptionDialog(dummy,
		 * "Please select positive or negative polarity\nSuggested polarity is " + pol, "CSW import",
